...
public class CustomJDBCRealm extends AuthorizingRealm {
	 ...
	 */
	protected static final String DEFAULT_AUTHENTICATION_QUERY = "select password from users where username = ? and tenant = ?";

	/**
	 * Rewrited to check <username, tenant> match
	 */
	protected static final String DEFAULT_SALTED_AUTHENTICATION_QUERY = "select password, password_salt from users where username = ? and tenant = ?";
